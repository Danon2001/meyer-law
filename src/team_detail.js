function showAchievements(){
    $('.hidden_achievements').removeClass('hidden');
    $('.show_ach_button').addClass('hidden');
}

function hideAchievements(){
    $('.hidden_achievements').addClass('hidden');
    $('.show_ach_button').removeClass('hidden');
}

function showBooks(){
    $('.hidden_books').removeClass('hidden');
    $('.show_bks_button').addClass('hidden');
}

function hideBooks(){
    $('.hidden_books').addClass('hidden');
    $('.show_bks_button').removeClass('hidden');
}

function showArticles(){
    $('.hidden_articles').removeClass('hidden');
    $('.show_art_button').addClass('hidden');
}

function hideArticles(){
    $('.hidden_articles').addClass('hidden');
    $('.show_art_button').removeClass('hidden');
}
